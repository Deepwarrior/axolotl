...
tasks = [['CAADAgADSgADP_vRD6EHNhBBV7W_Ag', 'ТЫ ДИП. ИСПОЛЬЗУЙ ДИПЯНКУ БЛИЖАЙШИЕ 300 СООБЩЕНИЙ.', 0, 300],
         ...
         ['CAADAgADQAADP_vRD85Bwdr_xrWpAg', 'ТЫ СУПЕР ТРУПЕР. ИСПОЛЬЗУЙ КАКИЕ-НИБУДЬ НЕОБЫЧНЫЕ СИМВОЛЫ В КАЖДОМ СООБЩЕНИИ.', 3, 300],
...
black_tasks = [
    ...
    ['CAADAgADOQADsjRGHrDrs5Pilb50Ag', "ТЫ ЧОРНЫЙ НМЛСС. НАЖАЛУЙСЯ НА ПРОВЕРЯТОРОВ.", 23, 0]
]
