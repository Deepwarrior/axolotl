...
black_tasks = [
    ['CAADAgADnAADP_vRD2a0vetXwpdzAg', 'ТЫ ЧОРНЫЙ АРЕАТАНГЕНТ. СОЗДАЙ АКТИВНЫЙ ЧАТ НА 10 ЧЕЛОВЕК И УДАЛИ ЕГО СПУСТЯ '
                                       'СУТКИ.', 23, 0],
    ['CAADAgADnQADP_vRD89N7c9JLwnzAg', 'ТЫ ЧОРНЫЙ ЦИТРУС. СПОЙ ВСЛУХ МАТЕРНУЮ ПЕСЕНКУ.', 23, 0],
...
#    ['CAADAgADoAADP_vRDwZOfbvGrhzSAg', 'ТЫ ЧОРНЫЙ ПОЛИНОМ ГАУССА. ЗАДАЙ МИШЕ ЗАДАЧКУ ПО МАТАНУ.', 23, 0],
    ...
    ['CAADAgADhgADE3yuAvQNwTNI94W-Ag', 'ТЫ ЧОРНЫЙ ИИОО. ИСПОЛЬЗУЙ В СООБЩЕНИЯХ ТОЛЬКО БУКВЫ С ЧЁТНЫМ НОМЕРОМ', 3, 0],
...
ng_tasks = ['СФОТОГРАФИРУЙ СВОЁ ОТРАЖЕНИЕ В ЁЛОЧНОЙ ИГРУШКЕ!',
