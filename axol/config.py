...
tasks = [['CAADAgADSgADP_vRD6EHNhBBV7W_Ag', 'ТЫ ДИП. ИСПОЛЬЗУЙ ДИПЯНКУ БЛИЖАЙШИЕ 300 СООБЩЕНИЙ.', 0, 300, "deep_check"],
         ...
         ['CAADAgADVwADP_vRD5bgjp3IrnbZAg', 'ТЫ ПОКРОВИТЕЛЬ БАРСИКОВ. ПИШИ В ЧАТ ИСКЛЮЧИТЕЛЬНО ФРАЗАМИ ИЗ ДНЕВНИКА.', 23, 0],
          ...
          ['CAADAgAD3AADP_vRD-MYOKSjfpS0Ag', 'ТЫ НЕВЫРАЗИМОЕ НЕЧТО. ВНИМАТЕЛЬНО СЛЕДИ ЗА КАКИМ-ЛИБО ИГРОКОМ В ТЕЧЕНИЕ ДНЯ'
                                            ' И СОСТАВЬ НА НЕГО ДОСЬЕ.', 23, 0],
...
black_tasks = [
    ...
    ['CAADAgADpQADP_vRD7AcdIk76-SsAg', 'ТЫ ЧОРНАЯ ЗОЛОТАНАНА. ОБЩАЙСЯ ТОЛЬКО СТИКЕРАМИ "УБЛЮДОК МАТЬ ТВОЮ..." ', 4, 0],
    ...
    ['CAADAgADSQADsjRGHk3DvMY4826-Ag', 'ТЫ ЧОРНЫЙ ЭЛЕКСОРИЕН. ОБРАЩАЙСЯ КО ВСЕМ ТАК, КАК БУДТО КАЖДЫЙ ПОМЕНЯЛ ПОЛ, ВКЛЮЧАЯ ТЕБЯ', 6, 0]
]
