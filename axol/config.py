...
hi_cifr = ['1', "НАДЕЮСЬ, ЗАВТРА ТЫ ПРО ДЛИННОКОТА НЕ ЗАБУДЕШЬ.", "ПРИВЕТ, ЦИФЕРКА",
           ...
           "ЗНАЕШЬ, СКОЛЬКО БУДЕТ -4.14358088 ФАКТОРИАЛ?", "ОПЯТЬ ТЫ С ЭТИМ СВОИМ СТИКЕРОМ"]
...
black_tasks = [
    ...
    ['CAADAgADsgADsjRGHk1MLafGlWBpAg', "ТЫ ЧОРНЫЙ АЛФОРЧУ. ОБЩАЙСЯ ТАК, БУДТО ТЕБЕ ОСТАЛОСЬ ЖИТЬ ВСЕГО ДЕНЬ.", 23, 0]
]
...
love_tasks = [
             ...
             'ВЫЛЕПИ ИЗ СНЕГА СКУЛЬПТУРУ СВОЕГО ИЗБРАННИКА'
             ]
...
grammar_nazi_explanation = [
    ...
    ['И ВСЁ-ТАКИ "', '"!'],
    ['И НЕ СТЫДНО ТЕБЕ ПИСАТЬ "', '" С ОШИБКАМИ, КОГДА СВЯТОЙ ДЛИНОМОЗЖЕ СМОТРИТ НА ТЕБЯ С НЕБЕС???']
                           ]
