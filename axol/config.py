...
dura_stickers = ['CAADAgADPA0AAmOLRgxiNSbi4FrFIQI', 'CAADAgADXgEAApCn4UhWMXWuxys4hQI', 'CAADAgADXwEAApCn4UiC_1xRUSuEnQI',
                 'CAADAgADYQEAApCn4UiFRSu_yOzOVQI', 'CAADAgADYgEAApCn4UjImbEdzDr_mQI', 'CAADAgADYwEAApCn4UgodgrcFOSmWgI',
                 'CAADAgADZAEAApCn4UgXr5K-u0wbEwI', 'CAADAgADZgEAApCn4UhMpsdF4iNwugI', 'CAADBAADEgADxXu1FF098lh1r0WXAg',
                 'CAADAgADZwEAApCn4Uiw2RepLzSHpgI', 'CAADAgADaAEAApCn4Ujw-dJI-RvTpgI', 'CAADAgADaQEAApCn4UgeYrApxx99VwI',
                 'CAADAgADbAEAApCn4UhSIim8y5EnggI', 'CAADAgADDAEAAh0g2UklBK0dPvIYpAI', 'CAADAgADDwEAAh0g2UkR4WnSY5RligI',
                 'CAADAgADwQEAAlKAsUlr0FKuiF1deAI', 'CAADAgADCwEAAh0g2UlK2pwlDR4vlQI', 'CAADBAADQQADFhjnEwqutVCiHz70Ag',
                 'CAADAgADxQEAAlKAsUnOGLbzLAqqIQI', 'CAADAgADxgEAAlKAsUmcwNQMlu_e7AI', 'CAADAgADCQEAAh0g2UnAjxI-oJ8meQI',
                 'CAADAgADxwEAAlKAsUnBL6JEg8jRVAI', 'CAADAgADyAEAAlKAsUmiRD2wg5PILQI', 'CAADAgADyQEAAlKAsUkLN0ZbdL2-LQI',
...
dura_do = ["ИСПОЛЬЗУЙ", "СПОЙ", "ОТПРАВЛЯЙ", "ПИШИ", "ЗАБАНЬ", "ЗАФЛУДИ", "ЭКОНОМЬ", "НЕ СДЕРЖИВАЙ", "СЛОМАЙ",
             "ПОМЕНЯЙ", "ПОСТАВЬ", "ПИШИ", "НАДЕНЬ", "ИСПОЛЬЗУЙ", "ВЫВЕДИ", "СПИЛИ", "ОТПРАВЬ", "ПИШИ", "НАРИСУЙ",
             "НАЙДИ", "ПОЙМАЙ", "ПОБЕДИ", "ИСПОЛЬЗУЙ", "ЗАПИРАТЬ", "ПИШИ", "ПРИДУМАЙ", "ПОПРОСИ", "ПОСЕЩАЙ", "СТАВЬ",
             "ПОЛУЧИ", "ПОСТАВЬ", "ПРЕДСКАЖИ", "ДОВЕДИ", "СПИЛИ", "ЗАКРОЙ", "ДОПИСЫВАЙ", "СДЕЛАЙ", "ПИШИ",
             ...
             "ЗАМЕНЯЙ", "ДОБАВЛЯЙ", "СДЕЛАЙ", "ПИШИ", "НАДЕНЬ", "СООБЩАЙ", "РАССКАЖИ", "НАПИШИ", "ПИШИ В ЧАТ",
...
dura_what = ["ДИПЯНКУ", "ПЕСЕНКУ", "КАЖДУЮ КАРТИНКУ И СТИКЕР", "СКОБОЧКИ", "ОДНОЧАТОВЦА", "ЧАТ", "ВИРТУАЛЬНОЕ ПРОСТАНСТВО",
             ...
             "ИГРУ", "САМЦОВ", "САМОК", "ДЛИННОКОТА ИЗ 50 ФРАГМЕНТОВ", "ГРУСТНУЮ ИСТОРИЮ ПРО СЕБЯ", "УНДОГЛЮКИ", "ВСЕХ",
             "ВСЕ СЛОВА", "УМЕНЬШИТЕЛЬНО-ЛАСКАТЕЛЬНЫЕ СУФФИКСЫ", "ДОНОС", "АВУ, НИК", "ЯРЕНУ", "ЧТО ТЕБЕ ПРИСНИЛОСЬ",
             "ХОККУ", "ФРАЗЫ ИЗ ДНЕВНИКА", "КРОВАТЬ", "ВСЕ СВОИ СООБЩЕНИЯ", "ДОСЬЕ", "СООБЩЕНИЯ", "СВОИ ДЕЙСТВИЯ",
             "ВСЕ ПИСЬМА ОТ ДРУГИХ ИГРОКОВ", "КРАСИВОЕ СТИХОТВОРЕНИЕ"
             ]
dura_how = ["150 СООБЩЕНИЙ",  "ВСЛУХ",  "ДИСТОРШН-БОТУ",  "ДВА ЧАСА",  "БАНХАММЕРОМ",  "БОЛЬШЕ ОСТАЛЬНЫХ",
            ...
            "К НОЖНИЦАМ",  "В КАЖДОМ СООБЩЕНИИ",  "В МОРЕ",  "НАОБОРОТ",  "ПОСЛЕ ТАБЛЕТОК",  "У МИШИ",
            ...
            "С ПОМОЩЬЮ КУЧИ СЛОВ",  "ХОТЯ БЫ НА 2 ЧАСИКА",  "ГРАМОТНО",  "С АНИМЕШНЫМИ ГЛАЗАМИ",
            "ЕСЛИ ВИДИТ ДИП",  "ЕСЛИ ВИДИТ УХИ",  "ТОЛЬКО С ПОМОЩЬЮ СТИКЕРОВ",
            "И НЕ ЗАХОДИ В ГОДВИЛЛЬ ЦЕЛЫХ 2 ЧАСА",  "И НЕ ОТВЕЧАЙ",
