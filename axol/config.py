...
black_tasks = [
    ['CAADAgADnAADP_vRD2a0vetXwpdzAg', 'ТЫ ЧОРНЫЙ АРЕАТАНГЕНТ. СОЗДАЙ ЧАТ НА 10 ЧЕЛОВЕК И УДАЛИ ЕГО СПУСТЯ СУТКИ.'],
    ['CAADAgADnQADP_vRD89N7c9JLwnzAg', 'ТЫ ЧОРНЫЙ ЦИТРУС. СПОЙ ВСЛУХ МАТЕРНУЮ ПЕСЕНКУ.'],
    ...
    ['CAADAgADnwADP_vRD1jC4eQFmAJkAg', 'ТЫ ЧОРНАЯ ИСКУСАТЕЛЬНИЦА. ПЕРЕРИСУЙ АВАТАРКУ ИГРОКА, КОТОРЫЙ НАПИСАЛ ДО ЭТОГО '
                                       'ЗАДАНИЯ, ЧТОБЫ БЫЛО ОБИДНО.'],
    ['CAADAgADoAADP_vRDwZOfbvGrhzSAg', 'ТЫ ЧОРНЫЙ ПОЛИНОМ ГАУССА. ЗАДАЙ МИШЕ ЗАДАЧКУ ПО МАТАНУ.'],
    ['CAADAgADoQADP_vRD74RXtY5uDaUAg', 'ТЫ ЧОРНЫЙ РЕЛЬС. ПРОСНИСЬ УТРОМ ПОРАНЬШЕ И ПРОКЛИНАЙ КАЖДОГО ПРОСНУВШЕГОСЯ В '
                                       'ЧАТЕ.'],
    ['CAADAgADogADP_vRD_rLxu_6ITGyAg', 'ТЫ ЧОРНАЯ МАРИЯ СЕРГЕЕВНА. ОБРАЩАЙСЯ КО ВСЕМ ПО ОТЧЕСТВУ.'],
    ['CAADAgADowADP_vRD2Mc_kqxw_zXAg', 'ТЫ ЧОРНЫЙ СИЛЬФУР. ВЫПОЛНИ ЗАДАНИЕ ДРУГОГО ИГРОКА ЛУЧШЕ ИЛИ БЫСТРЕЕ, ОБЕСПЕЧИВ '
                                       'ТАКИМ ОБРАЗОМ БАЯЗИД ЭТОМУ ИГРОКУ.'],
    ['CAADAgADpAADP_vRD1icH4V_v8UUAg', 'ТЫ ЧОРНЫЙ ШЕНМАН. ОТПРАВЬ АУДИОСООБЩЕНИЕ ДЛИТЕЛЬНОСТЬЮ ОКОЛО 40 СЕКУНД ТАК, '
                                       'ЧТОБЫ ВОЙСИ ПРАВИЛЬНО РАСПОЗНАЛА ВСЕ СЛОВА.'],
    ['CAADAgADpQADP_vRD7AcdIk76-SsAg', 'ТЫ ЧОРНАЯ ЗОЛОТАНАНА. ОБЩАЙСЯ ТОЛЬКО СТИКЕРАМИ "УБЛЮДОК МАТЬ ТВОЮ..." ']
]
