...
tasks = [['CAADAgADSgADP_vRD6EHNhBBV7W_Ag', 'ТЫ ДИП. ИСПОЛЬЗУЙ ДИПЯНКУ БЛИЖАЙШИЕ 300 СООБЩЕНИЙ.', 0, 300],
         ...
         ['CAADAgAD4wADP_vRD3P1rDM_KtGuAg', "ТЫ РИННЕКО. СООБЩАЙ О НАЧАЛЕ ЯРЕНЫ ЗА НЕСКОЛЬКО МИНУТ ДО ТОГО, КАК ЭТО СДЕЛАЕТ БОТ.", 23, 0],
         ['CAADAgADwgADP_vRDwFfN7W0PLTBAg', "ТЫ МОРСКАЯ ОСА. РАССКАЖИ, ЧТО ТЕБЕ СЕГОДНЯ ПРИСНИЛОСЬ. ЕСЛИ НИЧЕГО НЕ ПРИСНИЛОСЬ — БАЯЗИД.", 23, 0],
         ['CAADAgADyAADP_vRDw6_aW_q_VzrAg', "ТЫ УНХАЙЛИГ. НАПИШИ ХОККУ\nВ ДУЭЛИ САМЫЙ КОНЕЦ.\nОДИН ГЛАС - СТРОЧКА.", 23, 0],
